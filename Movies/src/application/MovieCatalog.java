...
public class MovieCatalog extends Application {
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    // Main scene
    mainScene = new Scene(layout, 700, 450);
  ...
  public static void addInitialMovies() {
	  ...
	  movie1.setUserRating("5");
	  movie3.setUserRating("4");
	  movie4.setUserRating("5");
	  movie6.setUserRating("2");
	  movie9.setUserRating("5");
	  movie11.setUserRating("3");
	  movie15.setUserRating("1");
